import svgPaths from "./svg-9yrxyhgnqz";
import { imgGroup, imgGroup1, imgGroup2, imgGroup3 } from "./svg-6jpn9";

function TextLoginText() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[4px] items-start left-0 not-italic px-[20px] py-[64px] text-black text-center top-[99px] w-[390px]" data-name="Text / Login Text">
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[20px] top-[630px] w-[350px]">
      <Frame1 />
    </div>
  );
}
...
function GuidanceTooltip() {
  return (
    <div className="absolute bg-[#48b2af] content-stretch flex flex-col gap-[4px] items-start left-1/2 px-[16px] py-[8px] rounded-[999px] shadow-[0px_2px_7px_0px_rgba(0,0,0,0.12)] top-[576px] translate-x-[-50%]" data-name="Guidance / Tooltip">
      ...
      <div className="absolute bottom-[-6px] flex h-[6px] items-center justify-center left-1/2 translate-x-[-50%] w-[20px]">
        <div className="flex-none rotate-[180deg]">
          <div className="h-[6px] relative w-[20px]" data-name="arrow">
            <div className="absolute bottom-0 left-0 right-0 top-[5.54%]" style={{ "--fill-0": "rgba(72, 178, 175, 1)" } as React.CSSProperties}>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="첫 로그인 (카카오)">
      <Frame />
      <HomeIndicatorLight />
      <TextLoginText />
      <Img />
